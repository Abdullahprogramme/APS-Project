...
find_powers_val = random.choice([4, 8, 9, 27, 32, ])
...
def find_powers(answer, number):
    ...
    for base in range(2, int(number**0.5) + 1):
        ...
        while base**exponent <= number:
            ...
            exponent += 1
    return str(power_representations) == answer
...
text5 = "What is the power of"+ str(find_powers_val)+ "\nand what is the base? Enter in the format 'base exponent'ie[(base, power)]: "
...
questions = [
    ...
    {'text': text5, 'chechk_answer': find_powers}
]
